...
//    }
    ...
    public BigDecimal redondear(BigDecimal valor) {
        int tercerDigito = valor.scale() > 2 ? Character.getNumericValue(valor.toString().charAt(3)) : 0;
        if (tercerDigito >= 6) {
...
//            BigDecimal valorICe = (valor.getFacTotalBaseGravaba().multiply(amb.getAmValorIce())).divide(BigDecimal.valueOf(100), 2, RoundingMode.FLOOR);
            ...
            linea = ("<infoTributaria>\n"
                    ...
                    + "                 <valor>" + redondear(valor.getFacIva()) + "</valor>\n"
                    + "              </totalImpuesto>\n"
                    + "         </totalConImpuestos>\n"
                    + "                 <propina>0</propina>\n"
            ...
            for (DetalleFactura item : listaDetalle) {
                ...
                linea = ("        <detalle>\n"
                        ...
                        + "                    <valor>" + redondear(item.getDetIva()) + "</valor>\n"
                        + "                </impuesto>\n"
