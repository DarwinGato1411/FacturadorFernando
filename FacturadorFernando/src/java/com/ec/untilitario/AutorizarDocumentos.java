...
//            BigDecimal valorICe = (valor.getFacTotalBaseGravaba().multiply(amb.getAmValorIce())).divide(BigDecimal.valueOf(100), 2, RoundingMode.FLOOR);
            ...
            for (DetalleFactura item : listaDetalle) {
                ...
                linea = ("        <detalle>\n"
                        ...
                        + ((!item.getIdProducto().getProdCodigoAux().equals("")) ? "            <codigoAuxiliar>" + removeCaracteres(item.getIdProducto().getProdCodigoAux()) + "</codigoAuxiliar>\n" : " ")
...
//            build.append(linea);
            ...
            linea = ("    <infoAdicional>\n"
                    ...
                    + "<campoAdicional nombre=\"RUC_PROVEEDOR\">1718264839001</campoAdicional>"
                    + "   </infoAdicional>\n"
                    + "</factura>\n");
            build.append(linea);
