...
//            String nickTo = MimeUtility.encodeText(amb.getAmNombreComercial());
            ...
            String HTMLENVIO = "<body style=\"color: #666; font-size: 14px; font-family: 'Open Sans',Helvetica,Arial,sans-serif;\">\n"
                    ...
                    + "		 DOCUMENTO ELECTRONICO DE: " + amb.getAmNombreComercial().toUpperCase() + "</strong></div>\n"
            ...
            /*VERIFICA SI SE DEBE RRENVIAR*/
            if (amb.getReenviarme()) {
                address = (amb.getAmCorreoReenviar() != null ? address + "," + amb.getAmCorreoReenviar() : address);
            }
            m.setRecipients(Message.RecipientType.TO,
                    InternetAddress.parse(address));
